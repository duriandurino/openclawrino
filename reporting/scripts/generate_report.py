...
def build_docx(data, output_path):
    ...
    if header_image.exists():
        ...
        run.add_picture(str(header_image), width=Inches(6.5))
    ...
    body_banner = ROOT / "assets" / "docs" / "header-banner.png"
    if body_banner.exists():
        try:
            doc.add_picture(str(body_banner), width=Inches(6.5))
        except Exception:
            pass
