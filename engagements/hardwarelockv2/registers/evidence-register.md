...
| EVI-011 | exploit | terminal output | forensic sweep, part 4, empty runtime directories and direct repairman logic inspection | 2026-04-14 13:29 PST | F-005, F-006, F-007, F-008 | internal | engagements/hardwarelockv2/incoming/forensic-sweep-2026-04-14-part4.md | yes |
| EVI-012 | exploit | terminal output | local `setup.enc` decryption and bootstrap installer analysis | 2026-04-14 14:33 PST | F-007, F-008 | internal | operator-provided Telegram outputs plus local artifact `~/hardwarelockv2-artifacts/setup.dec.sh` | yes |
| EVI-013 | exploit | terminal output | local searches and history/note review showing no surviving Phoenix installer artifacts or original env rollback source | 2026-04-14 14:43 PST | F-008 | internal | operator-provided Telegram outputs and local note captures under `/home/pi/Documents/` | yes |
