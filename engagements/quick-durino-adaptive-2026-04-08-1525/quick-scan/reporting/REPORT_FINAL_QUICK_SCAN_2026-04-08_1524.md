...
- Quick scan profile `webapp` ran against `durino.vercel.app` in `safe` mode and treated the target as a Vercel-hosted Next.js application serving as a public portfolio-style surface, capturing 5 meaningful candidate observations with highest provisional severity `High`.
...
- **Severity:** High
- **CVSS Score:** N/A
- **Affected Target:** durino.vercel.app
...
- **Hardening:** Review public profile, contact, and showcase metadata regularly so unnecessary personal or routing exposure does not accumulate over time.
- **References:** Quick scan profile: webapp, Execution mode: safe

### QS-002 — Server banner exposed (Vercel)
...
```
- **Impact:** This may help attackers profile the public portfolio deployment and combine routing or metadata clues with broader reconnaissance.
...
### QS-003 — Title: Adrian Alejandrino | Product Solutions Engineer

- **Severity:** Medium
- **CVSS Score:** N/A
- **Affected Target:** durino.vercel.app
- **Description:** Quick scan candidate from the recon phase: Title: Adrian Alejandrino | Product Solutions Engineer
- **Evidence:** ```
Quick scan candidate finding (observed) from recon: Title: Adrian Alejandrino | Product Solutions Engineer
```
...
### QS-004 — X-Content-Type-Options: nosniff not set (JS-heavy app)
...
### QS-005 — X-Frame-Options header not set (Next.js)
...
| QS-002 | Server banner exposed (Vercel) | Medium | Scheduled |
| QS-003 | Title: Adrian Alejandrino | Product Solutions Engineer | Medium | Scheduled |
| QS-004 | X-Content-Type-Options: nosniff not set (JS-heavy app) | Low | Low Priority |
| QS-005 | X-Frame-Options header not set (Next.js) | Low | Low Priority |
