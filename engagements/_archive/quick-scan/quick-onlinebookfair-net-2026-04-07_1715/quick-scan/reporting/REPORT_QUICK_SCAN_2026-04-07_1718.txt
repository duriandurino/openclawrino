...
- Profile: `webapp`
- Mode: `safe`
- Engagement: `quick-onlinebookfair-net-2026-04-07_1715`
- Steps executed: `3`
- Generated: `2026-04-07 17:18 PST`
...
- Quick scan profile `webapp` ran against `https://onlinebookfair.net` in `safe` mode and treated the target as a Vercel-hosted web application, capturing 4 meaningful candidate observations with highest provisional severity `High`.
...
**Phase:** recon
**Agent:** specter-recon
**Date:** 2026-04-07 17:18 PST
**Status:** complete

## Found

- A: 216.198.79.65, 64.29.17.1
...
- CNAME: ;; communications error to 8.8.8.8#53: timed out
