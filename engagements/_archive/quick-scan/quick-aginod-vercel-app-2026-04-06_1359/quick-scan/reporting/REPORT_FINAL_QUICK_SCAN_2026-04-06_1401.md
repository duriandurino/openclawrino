# Penetration Test Report — https://aginod.vercel.app/ (Quick Scan)

**Date:** 2026-04-06
**Target:** https://aginod.vercel.app/ (Quick Scan)
**Findings:** 5
...
2. **Title: Aginod - Relief Tracker** (Medium) — This may reveal useful attacker information or weaken defensive posture if left unaddressed.
3. **banner: server banner exposed** (Medium) — This may reveal useful attacker information or weaken defensive posture if left unaddressed.
...
- **Severity:** High
- **CVSS Score:** N/A
- **Affected Target:** https://aginod.vercel.app/
...
### QS-002 — Title: Aginod - Relief Tracker

- **Severity:** Medium
- **CVSS Score:** N/A
- **Affected Target:** https://aginod.vercel.app/
- **Description:** Quick scan candidate from the recon phase: Title: Aginod - Relief Tracker
- **Evidence:** ```
Quick scan candidate finding (observed) from recon: Title: Aginod - Relief Tracker
```
...
### QS-004 — header: missing X-Content-Type-Options header
...
### QS-005 — header: missing X-Frame-Options header
...
| QS-002 | Title: Aginod - Relief Tracker | Medium | Scheduled |
| QS-003 | banner: server banner exposed | Medium | Scheduled |
| QS-004 | header: missing X-Content-Type-Options header | Low | Low Priority |
| QS-005 | header: missing X-Frame-Options header | Low | Low Priority |
