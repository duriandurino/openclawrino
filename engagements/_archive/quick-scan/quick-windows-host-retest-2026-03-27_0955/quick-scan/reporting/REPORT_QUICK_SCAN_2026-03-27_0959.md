...
- Steps executed: `3`
- Generated: `2026-03-27 09:59 PST`
...
- Quick scan profile `windows-host` ran against `192.168.0.112` in `safe` mode and did not capture notable candidate findings from the current artifact set.
