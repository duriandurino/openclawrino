...
- Steps executed: `2`
- Generated: `2026-03-27 17:34 PST`
...
- Quick scan profile `graphql` ran against `https://example.com` in `safe` mode and did not capture notable candidate findings from the current artifact set.
