...
- 2026-04-28 14:46 GMT+8 — Added new timed boot-sequence observations from operator testing and submitted photos: early `F1` during startup can expose `Progress: Trying boot mode SD`, a transient GUI-like environment, and a short-lived shell-visible `tty1` phase before the wrong-device path retakes the console
